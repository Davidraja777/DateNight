...
function acceptDate() {
    var phoneNumber = '+6587392795'; // Replace with the phone number you want to send a message to
    var message = "Hello Abam David, I've accepted the date!"; // The message you want to send
